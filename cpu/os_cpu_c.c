...
OS_STK *OSTaskStkInit (void (*task)(void *pd), void *pdata, OS_STK *ptos, INT16U opt)
{
    ...
    *(--stk) = (INT32U)0x13;                /* SPSR  从第一个任务执行的时候会打开中断   0x13-->SVCMODE */
...
void  OSTimeTickHook (void)
{
    ...
    temp = TINT_CSTAT;          // clear Timer 4 Interrupt Status Bit
    TINT_CSTAT = temp;          // clear by writing "1"
    
    VIC0ADDR = 0;               // clear VIC0 address
}
#endif
